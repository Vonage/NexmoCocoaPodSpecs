...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://artifactory.ess-dev.com/artifactory/gradle-dev-local/com/nexmo/ios/MiniRTC/0.01.13.13/MiniRTC-0.01.13.13-iOS-Debug.zip" }
