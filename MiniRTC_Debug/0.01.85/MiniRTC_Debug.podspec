...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://artifactory.ess-dev.com/artifactory/gradle-dev-local/com/nexmo/ios/MiniRTC/0.01.85/MiniRTC-0.01.85-iOS-Debug.zip" }

  s.vendored_frameworks = ['iOSFramework.framework']

  s.frameworks = 'AVFoundation', 'AudioToolbox', 'Foundation', 'UIKit', 'CoreMedia', 'CoreTelephony', 'CFNetwork', 'SystemConfiguration', 'GLKit', 'VideoToolbox'
